...
CROP_ACTION_PLANS = {
    ...
    'kn': { "rice": {}, "maize": {} }, # Add Kannada translations here
    'hi': { "rice": {}, "maize": {} }  # Add Hindi translations here
}
CROP_DATA = {
...
# --- AI MODEL LOADING (CORRECTED PATH & FALLBACK) ---
@st.cache_resource
def load_crop_model():
    ...
    try:
        ...
        if os.path.exists(model_path):
            ...
            st.error(f"Fatal Error: Crop recommendation model not found in `models/crop_model.pkl`. Please ensure the file exists in your repo.")
            return None
...
def predict_crop_and_plan(crop_model, data, lang):
    if crop_model is None: return None
